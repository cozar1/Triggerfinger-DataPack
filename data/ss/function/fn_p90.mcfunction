...
execute at @a[scores={Rclick=1..,gun_cooldown=..0,reload_cooldown=..0},tag=fn_p90] run summon minecraft:arrow ~ ~1.5 ~ {Tags:["fireball"]}

execute at @a[scores={Rclick=1..,gun_cooldown=..0,reload_cooldown=..0},tag=fn_p90] positioned ~ ~1.5 ~ as @e[distance=..1,tag=fireball] positioned 0 0 0 store result score @s MotionX run data get entity @e[tag=aim,limit=1] Pos[0] 1000
execute at @a[scores={Rclick=1..,gun_cooldown=..0,reload_cooldown=..0},tag=fn_p90] positioned ~ ~1.5 ~ as @e[distance=..1,tag=fireball] positioned 0 0 0 store result score @s MotionY run data get entity @e[tag=aim,limit=1] Pos[1] 1000
execute at @a[scores={Rclick=1..,gun_cooldown=..0,reload_cooldown=..0},tag=fn_p90] positioned ~ ~1.5 ~ as @e[distance=..1,tag=fireball] positioned 0 0 0 store result score @s MotionZ run data get entity @e[tag=aim,limit=1] Pos[2] 1000
